...
DATABASES = {
    'default': {
        ...
        'USER': 'tanglu',                     # Not used with sqlite3.
        'PASSWORD': 'tanglu',                 # Not used with sqlite3.
...
SECRET_KEY = '0=!e08&amp;g3zd0+6)@v*3@p(ps#_zs8ak8mo_s-6lt&amp;=_9l@#*n!'
...
ROOT_URLCONF = 'tanglu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tanglu.wsgi.application'

TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, 'templates'),
    os.path.join(PROJECT_ROOT, 'tanglu/templates'),
